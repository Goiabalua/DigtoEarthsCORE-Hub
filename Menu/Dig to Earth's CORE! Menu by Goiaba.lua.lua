...
-- createToggle(Tabs.Main, "Triple Dominus", Color3.new(1, 0, 0), function(state)
...
--         end)
--     end
-- end, "Win a Diamond Triple Dominus.")
